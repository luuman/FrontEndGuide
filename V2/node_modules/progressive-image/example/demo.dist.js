...
/* harmony default export */ __webpack_exports__["a"] = function (Vue) {
  ...
  var EVENTS = ['scroll', 'wheel', 'mousewheel', 'resize'];
  var Util = {
    getAnimationEvent: function getAnimationEvent() {
  ...
  var events = function events(el, bind) {
    if (bind) {
  ...
  var animationEvent = Util.getAnimationEvent();
  ...
  var isExist = function isExist(el) {
    var exist = false;
  ...
  var render = function render(el, src, status) {
  ...
  var mountImage = function mountImage(item, img) {
    var preview = item.el;
    var parent = preview.parentNode;
    parent.appendChild(img).addEventListener(animationEvent, function (e) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_index_vue__ = __webpack_require__(0);
